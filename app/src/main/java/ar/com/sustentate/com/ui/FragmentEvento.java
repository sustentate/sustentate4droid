...
public class FragmentEvento extends Fragment implements EventosAdapter.Comunicador {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Evento evento = new Evento("Curso Jardineria de Otoño", "La Maestría en Derecho y Economía del Cambio Climático de FLACSO-Argentinainvita a participar del Curso “Cambio Climático y Ciudades” a cargo de la profesora Alejandra Ramírez Cuesta.  La materia se compone de 8 sesiones de 3 hs. cada una, que se dictarán a partir del martes 7 de mayo y hasta el jueves 30 de mayo.","De Los Reseros y N. Repetto (ex De Las Cabañas), Hurlingham Buenos Aires."
                ,new Date(119, 3,1,8,30),"https://gdurl.com/1ghm",null, arancelada);
        ...
        Evento evento3 = new Evento("Feria de consumo responsable", "El grupo de voluntarios del Corredor Verde Chascomús, invita a la Comunidad a participar de una Jornada de Plantación de especies nativas y avistamiento e identificación de mariposas. Nos encontramos en González Chavez y Bahía Blanca el domingo 17/03/19 a las 10:30 am","Diagonal Sur y Bolívar, CABA"
