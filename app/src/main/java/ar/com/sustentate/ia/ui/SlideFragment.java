...
public class SlideFragment extends Fragment {
    ...
    public static SlideFragment newInstance(int title, String subtitle, int backgroundColor, int image) {
        SlideFragment fragmentFirst = new SlideFragment();
        Bundle args = new Bundle();
        args.putInt("slideTitle", title);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        titleImage = getArguments().getInt("slideTitle");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView title = view.findViewById(R.id.fragment_title);
